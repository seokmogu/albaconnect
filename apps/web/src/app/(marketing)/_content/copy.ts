...
export const copy = {
  ...
  forEmployers: {
    sectionTitle: "사장님께",
    positioning:
      "알바몬은 광고, 당근알바는 동네 인맥. 알바몬 커넥트는 알고리즘 매칭입니다.",
  ...
  trustSafety: {
    ...
    pillars: [
      ...
      },
      {
        title: "24시간 분쟁 처리",
        description:
          "노쇼, 초과 근무, 페이 이견이 생기면 알바몬 커넥트 운영팀이 24시간 안에 검토합니다. 알고리즘이 아니라 사람이 해결해요.",
      },
    ],
  },
  stats: {
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        a: "토스 에스크로로 사장님이 예치한 금액은 매칭 완료 시에만 워커에게 정산됩니다. 노쇼 발생 시 차순위 워커에게 즉시 무료로 재디스패치되고, 분쟁은 알바몬 커넥트 운영팀이 24시간 내에 검토해서 처리해요. 사장님이 혼자 감당하지 않아도 됩니다.",
      },
      {
        q: "기존 알바 직원은 어떻게 되나요?",
        a: "알바몬 커넥트는 단기·결원 충원용 도구입니다. 기존 알바와 병행해서 갑작스러운 공백이나 피크타임 추가 인력만 메우는 용도로 권장해요. 기존 직원을 대체하기 위한 서비스는 아닙니다.",
      },
      {
        q: "위치 추적이 항상 켜져 있나요?",
