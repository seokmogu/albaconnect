...
export const copy = {
  ...
  header: {
    ...
    navItems: [
      ...
      { label: "개인 용역", href: "#for-gig-service" },
  ...
  hero: {
    ...
    // 헤드라인: 사업장 알바(고용형)와 개인 용역(용역형) 두 수요를 모두 포괄
    headline: "알바도 심부름도,\n30초 안에 사람을 구해요",
    subheadline:
  ...
  forGigService: {
    sectionTitle: "개인 용역",
    eyebrow: "C2C 도급 — 근로계약 아님",
    headline: "심부름·청소·짐옮기기…\n개인 용역도 30초 매칭",
    legalNote:
      "※ 개인 용역은 민법상 도급계약으로 체결됩니다. 근로계약이 아니므로 근로기준법·최저임금법 적용 대상이 아닙니다.",
    // 용역 의뢰인 관점 — 개인이 개인에게 일감을 맡기는 구조
    useCases: [
      "심부름 · 줄서기 · 도보 배달",
      "청소 · 조립 · 짐옮기기",
      "반려동물 돌봄 · 산책 대행",
    ...
    painPoints: [
      "지인한테 부탁하기 애매한 일이 있어요",
      "플랫폼마다 가입해도 적합한 사람 찾기가 어려워요",
      "비용 정산이 불투명하고 분쟁 시 보호가 없어요",
    ],
    solutions: [
      "의뢰 내용과 보수를 입력하면 반경 안 워커에게 즉시 알림이 가요",
